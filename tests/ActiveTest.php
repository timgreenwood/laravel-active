...
use TimGreenwood\Active\Active;
    ...
    public function setUp(): void
    {
        ...
        app('router')->group(['middleware' => ['dump']], function () {
            app('router')->get('/foo/bar',
                ['as' => 'foo.bar', 'uses' => '\TimGreenwood\ActiveTest\Http\DumpController@indexMethod']);
            app('router')->get('/foo/bar/{id}/view',
                ['as' => 'foo.bar.view', 'uses' => '\TimGreenwood\ActiveTest\Http\DumpController@viewMethod']);
            app('router')->get('/home', [
                'as'   => 'home',
                'uses' => function () {
                },
            ...
            app('router')->get('/model/{model}', '\TimGreenwood\ActiveTest\Http\DumpController@viewMethod');
        });
    }
    ...
    public function provideGetActionTestData()
    {
        return [
            'action is a controller method' => [
                ...
                '\TimGreenwood\ActiveTest\Http\DumpController@indexMethod',
            ],
            'action is a closure'           => [
                Request::create('/home'),
                'Closure',
    ...
    public function provideGetControllerTestData()
    {
        return [
            'controller is a controller method' => [
                Request::create('/foo/bar'),
                '\TimGreenwood\ActiveTest\Http\DumpController',
            ],
    ...
    public function provideCheckActionTestData()
    {
        return [
            ...
            'match the second inputted actions' => [
                Request::create('/foo/bar'),
                [
                    '\TimGreenwood\ActiveTest\Http\DumpController@viewMethod',
                    '\TimGreenwood\ActiveTest\Http\DumpController@indexMethod',
                ],
                true,
            ],
            'match no action'                   => [
                ...
                [
                    '\TimGreenwood\ActiveTest\Http\DumpController@viewMethod',
                    '\TimGreenwood\ActiveTest\Http\DumpController@deleteMethod',
                ],
                false,
            ],
        ];
    ...
    public function provideCheckControllerTestData()
    {
        return [
            ...
            'match the second inputted controllers' => [
                Request::create('/foo/bar'),
                ['Namespace\Child\Controller', '\TimGreenwood\ActiveTest\Http\DumpController'],
                true,
            ],
            'match no controller'                   => [
                Request::create('/foo/bar'),
